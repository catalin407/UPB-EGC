...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        vector<VertexFormat> verticesTetra
        {
            ...
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0,  1), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0.75f, 1,  0.75f), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
        ...
        vector<VertexFormat> verticesCube
        {
            ...
            VertexFormat(glm::vec3(1, 0,  1), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),//1
            VertexFormat(glm::vec3(0, 1,  1), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),//2
            VertexFormat(glm::vec3(1, 1,  1), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),//3
            //FACE2
            VertexFormat(glm::vec3(0, 1,  1), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),//4
            VertexFormat(glm::vec3(1, 1,  1), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),//5
            VertexFormat(glm::vec3(0, 1,  0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),//6
            VertexFormat(glm::vec3(1, 1,  0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),//7
            //FACE3
            VertexFormat(glm::vec3(1, 0,  1), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),//8
            VertexFormat(glm::vec3(1, 1,  1), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),//9
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),//10
            VertexFormat(glm::vec3(1, 1,  0), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),//11
            //FACE4
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),//12
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),//13
            VertexFormat(glm::vec3(0, 1,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),//14
            VertexFormat(glm::vec3(1, 1,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),//15
            //FACE5
            VertexFormat(glm::vec3(0, 0,  1), glm::vec3(1, 1, 0), glm::vec3(0.2, 0.8, 0.6)),//16
            VertexFormat(glm::vec3(1, 0,  1), glm::vec3(1, 1, 0), glm::vec3(0.2, 0.8, 0.6)),//17
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(1, 1, 0), glm::vec3(0.2, 0.8, 0.6)),//18
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(1, 1, 0), glm::vec3(0.2, 0.8, 0.6)),//19
            //FACE6
            VertexFormat(glm::vec3(0, 0,  1), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),//20
            VertexFormat(glm::vec3(0, 1,  1), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),//21
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),//22
            VertexFormat(glm::vec3(0, 1,  0), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6))//23
        ...
        CreateMesh("cube_C", verticesCube, indicesCube);
    }
...
void Lab2::CreateMesh(const char *name, const std::vector<VertexFormat> &vertices, const std::vector<unsigned int> &indices)
{
    ...
    unsigned int VBO = 0;
    // TODO(student): Create the VBO and bind itver
    glGenBuffers(1, &VBO);
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(5, 0.5f, 0), glm::vec3(0.75f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetra"], shaders["VertexColor"], glm::vec3(1, 0.5f, 0), glm::vec3(0.75f));


    // TODO(student): Draw the square
    RenderMesh(meshes["Square"], shaders["VertexColor"], glm::vec3(3, 0.5f, 0), glm::vec3(0.75f));

    //BONUS
    RenderMesh(meshes["cube_C"], shaders["VertexColor"], glm::vec3(6.5f, 0.5f, 0), glm::vec3(0.75f));
